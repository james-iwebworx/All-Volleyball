...
if (!customElements.get('variant-picker')) {
  class VariantPicker extends HTMLElement {
    ...
    updateVariantInput() {
      ...
      let cfbtn = document.getElementById("custom-fuze-button");
      if (cfbtn && customfuze_server_url?.length > 10)
        cfbtn.href = customfuze_server_url + "Home/Customize?variantId=" + this.variant.id;
    }
